...
from core.utils.user_mapping import get_user_id_by_name, format_filename_with_id, extract_user_from_path
...
class FileMigrationRenamer:
    ...
    def format_normalized_filename(self, components: Dict) -> str:
        """
        Format the normalized filename using the global component order and separator.
        Args:
        ...
        try:
            ...
            for component in component_order:
                if component == 'id':
                    value = components['user_id'] or ""
                elif component == 'name':
                    value = normalized_name
                elif component == 'remainder':
                    value = remainder
                elif component == 'date':
                    value = components['extracted_date'] or ""
                elif component == 'category':
                    value = components['category'] or ""
                else:
                    value = ""
