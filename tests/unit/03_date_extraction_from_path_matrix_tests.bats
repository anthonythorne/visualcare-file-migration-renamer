...
@test "extract_date_from_path - WHS/2025-07-15/Docs/Report_2025-07-15.pdf" {
  ...
  echo "cleaned remainder expected: WHS//Docs/Report_2025-07-15.pdf" >&2
  ...
  assert_equal "$cleaned_remainder" "WHS//Docs/Report_2025-07-15.pdf"
}
...
@test "2023/Temp Person/Temp Person File.txt - 2023/Temp Person/Temp Person File.txt" {
  cleaned_remainder=$(clean_date_filename_remainder "2023/Temp Person/Temp Person File.txt")
  echo "----- TEST CASE -----" >&2
...
@test "Unknown/2020/file.pdf - Unknown/2020/file.pdf" {
  cleaned_remainder=$(clean_date_filename_remainder "Unknown/2020/file.pdf")
  echo "----- TEST CASE -----" >&2
  echo "Comment: extract_date_from_path" >&2
