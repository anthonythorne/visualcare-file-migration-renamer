...
@test "extract_name_from_filename - jôn-döe-report.pdf" {
  ...
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Name with accents (only matches last name)" >&2
  echo "function: extract_name_from_filename" >&2
...
@test "extract_name_from_filename - maria-isabella-rodriguez-santos-report.pdf" {
  run extract_name_from_filename "maria-isabella-rodriguez-santos-report.pdf" "maria isabella rodriguez santos" "extract_name_from_filename"
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder matched <<< "$output"
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Name Parts - Hyphen separator" >&2
  echo "function: extract_name_from_filename" >&2
  echo "filename: maria-isabella-rodriguez-santos-report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
  echo "raw remainder expected: ----report.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: report.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: maria,isabella,rodriguez,santos" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "maria,isabella,rodriguez,santos"
  assert_equal "$raw_remainder" "----report.pdf"
  assert_equal "$cleaned_remainder" "report.pdf"
}

@test "extract_name_from_filename - maria_isabella_rodriguez_santos_report.pdf" {
  run extract_name_from_filename "maria_isabella_rodriguez_santos_report.pdf" "maria isabella rodriguez santos" "extract_name_from_filename"
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder matched <<< "$output"
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Name Parts - Underscore separator" >&2
  echo "function: extract_name_from_filename" >&2
  echo "filename: maria_isabella_rodriguez_santos_report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
  echo "raw remainder expected: ____report.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: report.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: maria,isabella,rodriguez,santos" >&2
  ...
  echo "---------------------" >&2
  assert_equal "$extracted_name" "maria,isabella,rodriguez,santos"
  assert_equal "$raw_remainder" "____report.pdf"
  assert_equal "$cleaned_remainder" "report.pdf"
}
...
@test "extract_name_from_filename - maria isabella rodriguez santos report.pdf" {
  ...
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Name Parts - Space separator" >&2
  echo "function: extract_name_from_filename" >&2
  echo "filename: maria isabella rodriguez santos report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
...
@test "extract_name_from_filename - maria.isabella.rodriguez.santos.report.pdf" {
  ...
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Name Parts - Period separator" >&2
  echo "function: extract_name_from_filename" >&2
  echo "filename: maria.isabella.rodriguez.santos.report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
...
@test "extract_initials_from_filename - m-i-r-s-report.pdf" {
  run extract_name_from_filename "m-i-r-s-report.pdf" "maria isabella rodriguez santos" "extract_initials_from_filename"
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder matched <<< "$output"
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Initials - Hyphen separator" >&2
  echo "function: extract_initials_from_filename" >&2
  echo "filename: m-i-r-s-report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
  echo "raw remainder expected: -report.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: report.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: m-i-r-s" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "m-i-r-s"
  assert_equal "$raw_remainder" "-report.pdf"
  assert_equal "$cleaned_remainder" "report.pdf"
}
...
@test "extract_initials_from_filename - m.i.r.s.report.pdf" {
  ...
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Initials - Period separator" >&2
  echo "function: extract_initials_from_filename" >&2
  echo "filename: m.i.r.s.report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
...
@test "extract_initials_from_filename - m i r s report.pdf" {
  ...
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Initials - Space separator" >&2
  echo "function: extract_initials_from_filename" >&2
  echo "filename: m i r s report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
...
@test "extract_initials_from_filename - m_i_r_s_report.pdf" {
  run extract_name_from_filename "m_i_r_s_report.pdf" "maria isabella rodriguez santos" "extract_initials_from_filename"
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder matched <<< "$output"
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Four Initials - Underscore separator" >&2
  echo "function: extract_initials_from_filename" >&2
  echo "filename: m_i_r_s_report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: true" >&2
  echo "raw remainder expected: _report.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: report.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: m_i_r_s" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "m_i_r_s"
  assert_equal "$raw_remainder" "_report.pdf"
  assert_equal "$cleaned_remainder" "report.pdf"
}

@test "extract_shorthand_name_from_filename - m-rodriguez-report.pdf" {
  run extract_name_from_filename "m-rodriguez-report.pdf" "maria isabella rodriguez santos" "extract_shorthand_name_from_filename"
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder matched <<< "$output"
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Shorthand Not Applicable - Four Names" >&2
  echo "function: extract_shorthand_name_from_filename" >&2
  echo "filename: m-rodriguez-report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: false" >&2
  echo "raw remainder expected: m-rodriguez-report.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: m rodriguez report.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: " >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" ""
  assert_equal "$raw_remainder" "m-rodriguez-report.pdf"
  assert_equal "$cleaned_remainder" "m rodriguez report.pdf"
}

@test "extract_shorthand_name_from_filename - m.santos-report.pdf" {
  run extract_name_from_filename "m.santos-report.pdf" "maria isabella rodriguez santos" "extract_shorthand_name_from_filename"
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder matched <<< "$output"
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  echo "Comment: Shorthand Not Applicable - Four Names" >&2
  echo "function: extract_shorthand_name_from_filename" >&2
  echo "filename: m.santos-report.pdf" >&2
  echo "name to match: maria isabella rodriguez santos" >&2
  echo "expected_match: false" >&2
  echo "raw remainder expected: m.santos-report.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: m santos report.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: " >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
