...
@test "extract_name_from_path - Medical/2024/Smith Jane/Smith Jane Report for Jane.pdf" {
  ...
  echo "expected_match: true" >&2
  echo "raw remainder expected: Medical 2024 Report for Jane pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: Medical 2024 Report for Jane pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Smith Jane" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Smith Jane"
  assert_equal "$raw_remainder" "Medical 2024 Report for Jane pdf"
  assert_equal "$cleaned_remainder" "Medical 2024 Report for Jane pdf"
}
...
@test "extract_name_from_path - 2023/Temp Person/Temp Person File.txt" {
  ...
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Temp Person" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Temp Person"
...
@test "extract_name_from_path - Client Files/2024/Support Plans/Mary Jane Wilson/Mary Jane Wilson Progress Report.pdf" {
  ...
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Mary Jane Wilson" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Mary Jane Wilson"
...
@test "extract_name_from_path - Documents/Personal Care/John Michael Smith/John Michael Smith Assessment 2024.pdf" {
  ...
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: John Michael Smith" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "John Michael Smith"
...
@test "extract_name_from_path - Archive/2023/Incident Reports/Sarah Johnson/Sarah Johnson Incident Report.pdf" {
  ...
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Sarah Johnson" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Sarah Johnson"
...
@test "extract_name_from_path - Photos & Videos/2024/Client Photos/Anne-Marie O'Connor/Anne-Marie O'Connor Photo Album.zip" {
  ...
  echo "expected_match: true" >&2
  echo "raw remainder expected: Photos Videos 2024 Client Photos Anne Marie O'Connor Anne Marie O'Connor Photo Album zip" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: Photos Videos 2024 Client Photos Anne Marie O'Connor Anne Marie O'Connor Photo Album zip" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Anne-Marie O'Connor" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Anne-Marie O'Connor"
  assert_equal "$raw_remainder" "Photos Videos 2024 Client Photos Anne Marie O'Connor Anne Marie O'Connor Photo Album zip"
  assert_equal "$cleaned_remainder" "Photos Videos 2024 Client Photos Anne Marie O'Connor Anne Marie O'Connor Photo Album zip"
}

@test "extract_name_from_path - Behavioral Support/2023/Reports/Robert Williams Jr./Robert Williams Jr. Behavioral Analysis.pdf" {
  run extract_name_from_path "Behavioral Support/2023/Reports/Robert Williams Jr./Robert Williams Jr. Behavioral Analysis.pdf" "Robert Williams Jr."
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder cleaned_remainder matched <<< "$output"
  echo "----- TEST CASE -----" >&2
  echo "Comment: Name with suffix" >&2
  echo "function: extract_name_from_path" >&2
  echo "full_path: Behavioral Support/2023/Reports/Robert Williams Jr./Robert Williams Jr. Behavioral Analysis.pdf" >&2
  echo "name to match: Robert Williams Jr." >&2
  echo "expected_match: true" >&2
  echo "raw remainder expected: Behavioral Support 2023 Reports Robert Williams Jr Robert Williams Jr Behavioral Analysis pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: Behavioral Support 2023 Reports Robert Williams Jr Robert Williams Jr Behavioral Analysis pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Robert Williams Jr." >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Robert Williams Jr."
  assert_equal "$raw_remainder" "Behavioral Support 2023 Reports Robert Williams Jr Robert Williams Jr Behavioral Analysis pdf"
  assert_equal "$cleaned_remainder" "Behavioral Support 2023 Reports Robert Williams Jr Robert Williams Jr Behavioral Analysis pdf"
}
...
@test "extract_name_from_path - Medical Records/2024/Assessments/Elizabeth van der Berg/Elizabeth van der Berg Medical Assessment.pdf" {
  ...
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Elizabeth van der Berg" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Elizabeth van der Berg"
...
@test "extract_name_from_path - Support Plans/2023/Active Plans/Maria José Rodriguez/Maria José Rodriguez Support Plan.pdf" {
  ...
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Maria José Rodriguez" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Maria José Rodriguez"
...
@test "extract_name_from_path - Emergency Contacts/2024/Updated Contacts/Jean-Pierre Dubois/Jean-Pierre Dubois Contact Details.pdf" {
  ...
  echo "expected_match: true" >&2
  echo "raw remainder expected: Emergency Contacts 2024 Updated Contacts Jean Pierre Dubois Jean Pierre Dubois Contact Details pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: Emergency Contacts 2024 Updated Contacts Jean Pierre Dubois Jean Pierre Dubois Contact Details pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Jean-Pierre Dubois" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Jean-Pierre Dubois"
  assert_equal "$raw_remainder" "Emergency Contacts 2024 Updated Contacts Jean Pierre Dubois Jean Pierre Dubois Contact Details pdf"
  assert_equal "$cleaned_remainder" "Emergency Contacts 2024 Updated Contacts Jean Pierre Dubois Jean Pierre Dubois Contact Details pdf"
}
...
@test "extract_name_from_path - Receipts/2023/Expense Reports/David O'Reilly/David O'Reilly Expense Report.pdf" {
  ...
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: David O'Reilly" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "David O'Reilly"
...
@test "extract_name_from_path - Mealtime Management/2024/Diary Records/Patricia Thompson-Smith/Patricia Thompson-Smith Food Diary.pdf" {
  ...
  echo "expected_match: true" >&2
  echo "raw remainder expected: Mealtime Management 2024 Diary Records Patricia Thompson Smith Patricia Thompson Smith Food Diary pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: Mealtime Management 2024 Diary Records Patricia Thompson Smith Patricia Thompson Smith Food Diary pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Patricia Thompson-Smith" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Patricia Thompson-Smith"
  assert_equal "$raw_remainder" "Mealtime Management 2024 Diary Records Patricia Thompson Smith Patricia Thompson Smith Food Diary pdf"
  assert_equal "$cleaned_remainder" "Mealtime Management 2024 Diary Records Patricia Thompson Smith Patricia Thompson Smith Food Diary pdf"
}
