...
@test "extract_name_from_path - WHS - John Doe/2025/Docs John Doe/Report Notes for John Doe Incidents.pdf" {
  ...
  echo "raw remainder expected: WHS -  Doe/2025/Docs  Doe/Report Notes for   Incidents.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: WHS Doe 2025 Docs Doe Report Notes for Incidents.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: John,John,John,Doe" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "John,John,John,Doe"
  assert_equal "$raw_remainder" "WHS -  Doe/2025/Docs  Doe/Report Notes for   Incidents.pdf"
  assert_equal "$cleaned_remainder" "WHS Doe 2025 Docs Doe Report Notes for Incidents.pdf"
}
...
@test "extract_name_from_path - Medical/2024/Smith Jane/Smith Jane Report for Jane.pdf" {
  ...
  echo "expected_match: true" >&2
  echo "raw remainder expected: Medical/2024/ Jane/  Report for .pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: Medical 2024 Jane Report for.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Jane,Jane,Smith,Smith" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Jane,Jane,Smith,Smith"
  assert_equal "$raw_remainder" "Medical/2024/ Jane/  Report for .pdf"
  assert_equal "$cleaned_remainder" "Medical 2024 Jane Report for.pdf"
}
...
@test "extract_name_from_path - 2023/Temp Person/Temp Person File.txt" {
  ...
  echo "expected_match: true" >&2
  echo "raw remainder expected: 2023/Temp Person/Temp  File.txt" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: 2023 Temp Person Temp File.txt" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: Person" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "Person"
  assert_equal "$raw_remainder" "2023/Temp Person/Temp  File.txt"
  assert_equal "$cleaned_remainder" "2023 Temp Person Temp File.txt"
}
...
@test "extract_name_from_path - NDIS/2022/John D/John D - Summary John D.pdf" {
  ...
  echo "expected_match: true" >&2
  echo "raw remainder expected: NDIS/2022/John D/John  - Summary .pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  echo "cleaned remainder expected: NDIS 2022 John D John Summary.pdf" >&2
  echo "cleaned remainder matched: $cleaned_remainder" >&2
  echo "extracted_name expected: John D,D" >&2
  echo "extracted_name matched: $extracted_name" >&2
  echo "expected match: $matched" >&2
  echo "---------------------" >&2
  assert_equal "$extracted_name" "John D,D"
  assert_equal "$raw_remainder" "NDIS/2022/John D/John  - Summary .pdf"
  assert_equal "$cleaned_remainder" "NDIS 2022 John D John Summary.pdf"
}

@test "extract_name_from_path - Unknown/2020/file.pdf" {
  run extract_name_from_path "Unknown/2020/file.pdf" "John Doe"
  [ "$status" -eq 0 ]
  IFS='|' read -r extracted_name raw_remainder matched <<< "$output"
  cleaned_remainder=$(clean_filename_remainder "$raw_remainder")
  echo "----- TEST CASE -----" >&2
  ...
  echo "raw remainder expected: Unknown/2020/file.pdf" >&2
  echo "raw remainder matched: $raw_remainder" >&2
  ...
  assert_equal "$raw_remainder" "Unknown/2020/file.pdf"
